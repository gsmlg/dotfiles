...
(defun gsmlg-server-configure-socket-directory ()
  "Keep TCP auth under XDG state; leave UNIX sockets at Emacs defaults.

Plain `emacsclient' then finds `$XDG_RUNTIME_DIR/emacs' or `/tmp/emacs$UID'
without `EMACS_SOCKET_NAME'."
