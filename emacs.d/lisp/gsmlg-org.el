...
When the Org Note bridge is active, `org-agenda-files' is feed-only."
  (setopt org-directory gsmlg-org-directory
          org-agenda-files
          (if (and (bound-and-true-p gsmlg-org-note-org--activated)
                   (fboundp #'gsmlg-org-note-org-agenda-files))
