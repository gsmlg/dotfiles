...
(declare-function gsmlg-format-buffer "gsmlg-eglot" ())
...
(defun gsmlg--configure-vertico-keys ()
  "Preserve quit and navigation keys for `consult-yank-pop'."
...
(keymap-global-set "C-c p" gsmlg-project-prefix-map)
